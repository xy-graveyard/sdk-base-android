 ...
 * etc.</p>
 * <p/>
 * <p>See the usages below to getUniqueId the consumer friends name of a device:</p>
 * <p/>
 * <p><b>Get the name of the current device:</b></p>
 * <p/>
 * <pre class="prettyprint">
 * String deviceName = XYDeviceName.getDeviceName();
 * </pre>
 * <p/>
 * <p>The above code will getUniqueId the correct device name for the top 600 Android devices. If the
 ...
 * XYDeviceName.getDeviceName("clark", "Unknown device");
 * </pre>
 * <p/>
 * <p><b>Get information about the device:</b></p>
 * <p/>
 * <pre class="prettyprint">
 * XYDeviceName.with(context).request(new XYDeviceName.Callback() {
 * <p/>
 * &#64;Override public void onFinished(XYDeviceName.DeviceInfo info, Exception error) {
 ...
 * list. It will be up-to-date with Google's supported device list so that you will getUniqueId the correct
 ...
 * calls.</p>
 */
public class XYDeviceName {
    // @formatter:on

    // JSON which is derived from Google's PDF document which contains all devices on Google Play.
    // To getUniqueId the URL to the JSON file which contains information about the device name:
    ...
    /**
     * Create a new request to getUniqueId information about a device.
     *
    ...
    public static String getDeviceName(@Nullable String codename, @Nullable String model, String fallback) {
        // ----------------------------------------------------------------------------
        // Acer
     ...
     */
    @Nullable
    private static DeviceInfo getDeviceInfo(@NonNull Context context, @NonNull String codename, @Nullable String model) {
    ...
    /**
     * Callback which is invoked when the {@link XYDeviceName.DeviceInfo} is finished loading.
     */
    public interface Callback {

        /**
         * Callback to getUniqueId the device info. This is run on the UI thread.
         *
         * @param info  the requested {@link XYDeviceName.DeviceInfo}
    ...
    public static final class Request {
        ...
        private Request(@NonNull Context ctx) {
            context = ctx;
         ...
         *
         * @param callback the callback to retrieve the {@link XYDeviceName.DeviceInfo}
         */
    ...
    public static final class DeviceInfo {
        ...
        private DeviceInfo(@NonNull JSONObject jsonObject) throws JSONException {
